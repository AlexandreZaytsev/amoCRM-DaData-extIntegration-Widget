...
//	$dvalue = isset($_POST['dvalue']) ? $_POST['dvalue'] : '';
...
public function openDadata() {
	
//$dadata = new Dadata($dadata_token, null);
//$dadata->init();
return $dadata_token;
}

public function closeDadata() {
 $dadata->close();
return "2";
}

public function findINN(){
  $fields = array("query" => "7723002186", "count" => 5);
...
//$fields = array("query" => "7723002186", "count" => 5);
$fields = array("query" => $dvalue, "count" => 5);
//console.log($fields);
$result = $dadata->suggest("party", $fields);
