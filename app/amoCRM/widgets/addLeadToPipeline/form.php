	...
	<form action="../../amo/setParty.php" method="post"> 
		<div class="uk-card uk-card-default uk-card-small">
    		<div class="uk-card-header uk-background-muted uk-padding-remove">
				...
				<input id="userid" name="userid" class="uk-input uk-form-small" hidden></input>
            	...
            	<div  uk-grid>
    				<div class="uk-width-1-2@s">
        				<input class="uk-input uk-form-small" rows="1" name="lead" placeholder="Введите наименование Lead" required></input>
    				</div>
    				<div class="uk-width-1-2@s uk-margin-remove-top">
						<select id="selPipeline" name="pipeline" class="uk-select uk-form-small" placeholder="воронок не найдено..." required>
			...
			<div class="uk-card-footer uk-background-muted uk-padding-remove">
				<button class="uk-button uk-button-text" type="su_bmit" >Добавить в amoCRM</button>
			</div>
		</div>
	</form>  
</div>
